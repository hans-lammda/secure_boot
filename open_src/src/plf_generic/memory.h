...
#define __PMILL_MEMORY_H__ "$HeadURL: https://cm-ext.dev.oniteo.com/svn/nanodev/packages/plf_generic/trunk/plf_generic/memory.h $ $Revision: 20537 $"
...
/*! \brief Allocates memory pool
    ...
    \param[in] test enabled if true  

    \retval 1 if memory test is passed  
    \retval 0 if memory test fails 
